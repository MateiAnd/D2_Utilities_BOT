...
import discord
from sherpa import sherpa_channel
        ...
        if self.button_lable == 'Cancel':
            ...
            async def click(interaction: discord.Interaction):
                if await compare_users(interaction, author, interaction.user):
                    ...
                    if org_dict['Activity'] == 'Raid':
                        org_dict['Max Number'] = 6
                    else:
                        org_dict['Max Number'] = 3
        ...
        if self.button_lable == 'Cancel':
            ...
            async def click(interaction: discord.Interaction):
                if await compare_users(interaction, author, interaction.user):
                    ...
                    if org_dict['Editing']:
                        await sherpa_channel.init_edit(bot=_bot, org_dict=org_dict)
                    ...
                    await sherpa_channel.initializare_mesaj(bot=_bot, org_dict=org_dict)
